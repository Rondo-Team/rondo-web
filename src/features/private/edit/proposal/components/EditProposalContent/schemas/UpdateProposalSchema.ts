...
export const UpdateProposalSchema = (t: (arg: string) => string) =>
  z.object({
    title: z
...
type UpdateProposalSchemaType = ReturnType<typeof UpdateProposalSchema>;
export type UpdateProposalActionDTO = z.infer<UpdateProposalSchemaType>;
